                                                            ...
                                                            <div class="card border-0 rounded-0">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6 pr-0 text-left">
                                                                        <button type="button" class="btn btn-danger shadow-none w-100 rounded-0 waves-effect waves-themed" data-toggle="modal" data-target=".modal:not(.js-modal-settings):not(.modal-alert)">
                                                                            <strong>Bank Buy</strong>
                                                                        </button>
                                                                    </div>
                                                                    <div class="col-md-6 pl-0 text-right">
                                                                        <button type="button" class="btn btn-success shadow-none w-100 rounded-0 waves-effect waves-themed" data-toggle="modal" data-target=".modal:not(.js-modal-settings):not(.modal-alert)">
                                                                            <strong>Bank Sell</strong>
                                                                        </button>
                                                                    </div>
                                                                </div>
