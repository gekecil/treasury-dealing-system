...
@section('title', 'Cancellations - Sales')
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-times-square'></i> Cancellations
                            </h1>
                        </div>
@if (session('status'))
...
@endif
                        <div class="row">
                            <div class="col-xl-12">
                                <div id="panel-cancellation-index" class="panel">
                                    <div class="panel-hdr">
                                        <h2>Cancellation <span class="fw-300"><i>Table</i></span></h2>
